...
class Banner_model extends CI_Model{
	...
	function get_category_banner_list()
	{
		$q = "select * from category_banner_tb order by `precedence` DESC";
		$query = $this->db->query($q);
		return $query->result_array();	
	}
	...
	function get_selected_category_banner_data($id)
	{
		$q = "select * from category_banner_tb where `id` = '".esc($id)."'";
		$query = $this->db->query($q);
		return $query->row_array();	
	}
	...
	function get_active_category_banner_list($id)
	{
		$q = "select * from category_banner_tb where id = '".esc($id)."' ";
		$query = $this->db->query($q);
		return $query->row_array();	
	...
	function update_category_banner($id, $data)
	{
		$this->db->update('category_banner_tb', $data, array('id'=>$id));
	}
	...
	{
		$sql = "update category_banner_tb set image = '' where id = '".esc($id)."'";
		$this->db->query($sql);	
	}
	...
	function update_active_category_banner($id,$active)
	{
		$q = "update category_banner_tb set `active` = '".esc($active)."' where id='".esc($id)."' ";
		$query = $this->db->query($q);
	}
