...
class Coupon extends CI_Controller {
	...
	function doadduser()
	{
	 ...
	 function set_active_coupon(){
	 	$active = $this->input->post('check');
		$check = $this->coupoun_model->check_active_coupon();
		
		if($check){
			$this->coupoun_model->update_active_coupon($active);
		}else{
			$this->coupoun_model->insert_active_coupon($active);
		}
	 }
}