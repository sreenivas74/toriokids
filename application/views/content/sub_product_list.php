                        ...
                        <div class="filterBox">
                            <div class="filterWrapper">
                                ...
                                <div class="categoryTab">
                                    ...
                                    <h4>Category</h4>
                                    <ul class="optionBox">
                                        <?php $no=0; if($sub_cat2)foreach($sub_cat2 as $list){ ?>
                                        <li><input type="checkbox" value="<?php echo $list['id'] ?>" <?php if($sub_name == $list['name']){ echo "checked"; } ?> name="category[]" class="optionTab" id="category<?php echo $no ?>"><label for="category<?php echo $no ?>"><?php echo $list['name'] ?></label></li>
                                        <?php $no++; } ?>
                        ...
                        <div class="productBox">
                            ...
                            <div class="productPanel">
                                ...
                                <div class="productImage">
                                    <a href="<?php echo site_url('product/view_product_detail'.'/'.$pro['alias'].'/'.$cat_id.'/'.$sub_cat['id'])?>"  title="<?php echo $pro['name'];?>"><img src="<?php echo base_url();?>userdata/product/<?php echo find_2_prec('image', 'product_id', $pro['id'], 'product_image_tb');?>" alt="<?php echo $pro['name'];?>"/></a>
                                </div>
                                <div class="productDesc">
                                    <a href="<?php echo site_url('product/view_product_detail'.'/'.$pro['alias'].'/'.$cat_id.'/'.$sub_cat['id'])?>" title="<?php echo $pro['name'];?>"><span class="productName"><?php echo $pro['name'];?></span></a>
                                    <?php if($sale_id==0){?>
                                        <?php 
