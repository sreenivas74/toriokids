<section>
                ...
                <div class="mainWrapper nobanner">
                    <div class="productWrapper">
                            ...
                            <div class="filterWrapper">
                                ...
                                <div class="categoryTab">
                                    ...
                                    <ul class="optionBox">
                                        ...
                                        <li><input type="checkbox" value="<?php echo $list['id'] ?>" <?php if($sub_category1) foreach ($sub_category1 as $a) { if($list['id']==$a){ echo "checked"; } }?> name="category[]" class="optionTab" id="category<?php echo $no ?>"><label for="category<?php echo $no ?>"><?php echo $list['name'] ?></label></li>
                                        <?php $no++; } ?>
                        ...
                        <div class="tagWrapper">
                            <?php if($sub_cat)foreach($sub_cat as $list){ ?>
                                <?php if($sub_category1) foreach ($sub_category1 as $a) { if($list['id']==$a){ ?> 
                                <div class="tagBar" data-param="category%5B%5D" data-value="<?php echo $list['id'] ?>"><span><?php echo $list['name'] ?></span><a id="category<?php echo $list['id'] ?>" class="closeTag category<?php echo $list['id'] ?>"></a></div>
                                <?php } }?>
                            <?php } ?>
                            ...
                            <?php } ?> 
                            <div class="tagBar" style="display:none" data-param="category_name" data-value="<?php echo $cat['name'] ?>"><span><?php echo $cat['name'] ?></span><a href="#" class="closeTag"></a></div>
                        </div>
                        <?php if($product){?>
    ...
    $('.tagBar .closeTag').on('click', function(){
        ...
        var base_url = "<?php echo base_url('product/filter?'); ?>";
        console.log(getHTML);
