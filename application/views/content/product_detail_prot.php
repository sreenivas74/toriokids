                	...
                	<div class="productWrapper">
                        ...
                        <div class="productdetailBox">
                            ...
                            <div class="descBox">
                                ...
                                <?php if($cat_name == "Boys"){ ?>
                                <a href="http://www.toriokids.com/content/boy-size-chart-8" class="sizeChart">See Size Chart</a>
                                <?php }else{ ?>
                                <a href="http://www.toriokids.com/content/girl-size-chart-9" class="sizeChart">See Size Chart</a>
                                <?php } ?>
