        ...
        <section>
            <div class="contentWrapper">
                ...
                <div class="homeBanner">
                    <ul class="bannerSlider">
                        <?php if($home_banner) foreach($home_banner as $home){  ?>
                            <?php if($home['link']){ ?><a href="<?php echo $home['link'] ?>"> <?php } ?>
                            <li><img src="<?php echo base_url() ?>userdata/home_banner/<?php echo $home['image'] ?>"></li>
                            <?php if($home['link']){ ?></a> <?php } ?>
                        <?php } ?>
                    </ul>
                ...
                <div class="homemobileBanner">
                    <ul class="bannermobileSlider">
                        <?php if($home_banner) foreach($home_banner as $home){  ?>
                        <?php if($home['link']){ ?><a href="<?php echo $home['link'] ?>"> <?php } ?>
                        <li><img src="<?php echo base_url() ?>userdata/home_banner/<?php echo $home['image_mobile'] ?>"></li>
                        <?php if($home['link']){ ?></a> <?php } ?>
                        <?php } ?>
                    </ul>
                </div>
                        ...
                        <ul>
                            <li>
                                <div class="imageWrapper">
                                    <img src="<?php echo base_url() ?>userdata/category_banner/<?php echo $boys_banner['image'] ?>">
                                </div>
                                <div class="panelTab">
                                    <ul>
                            ...
                            <li>
                                <div class="imageWrapper">
                                    <img src="<?php echo base_url() ?>userdata/category_banner/<?php echo $girls_banner['image'] ?>">
                                </div>
                                <div class="panelTab">
                                    <ul>
