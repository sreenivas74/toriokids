...
<head>
    <meta charset="utf-8" />
    <title>Torio Kids. New Account Password</title>
	<style type="text/css">
    ...
    <div id="body_style" style="padding:15px;">
        ...
        <table cellpadding="0" cellspacing="10" border="0" bgcolor="#fff" width="800" align="center" style="line-height:18px; padding:0; border:5px solid #DBF291; background:#fff;">
            ...
            <tr>
                <td>
                    <p>
                        Hi, <strong><?php echo $detail['full_name'];?></strong>, please find below your Torio Kids account new password:<br /><br />
                    </p>
                    <p>
                        <strong><?php echo $pass;?></strong>
                    </p><br />
                    Please feel free to ask us any questions, or tell us anything about the forgot password process, or make any other constructive comments by sending an e-mail to <span style="color:#9E005D;">info@toriokids.com</span>
                </td>
            </tr>
            <tr>
