        ...
        <table cellpadding="0" cellspacing="10" border="0" bgcolor="#fff" width="800" align="center" style="line-height:18px; padding:0; border:5px solid #DBF291; background:#fff;">
            ...
            <tr>
                <td>
                    ...
                    Thank you for your interest to subscribe to <a href="<?php echo base_url();?>" style="color:#9E005D;">Torio Kids.</a> newsletter.
                    <br /><br />
                    To verify and activate your subscription, please click on this link<br />
                    ...
                    <a target="_blank" href="<?php echo $cancel_link;?>" style="color:#09F;"><?php echo $cancel_link;?></a>
                    <br /><br />
                    Or if clicking the link above does not work, you can try to copy and paste it into your browser.
                    <br /><br />
