    ...
    <?php if($this->session->userdata('admin_id')!=2){ ?>
        ...
        <li><strong>Banner</strong>
        	<ul>
                ...
                <li><a href="<?php echo site_url('torioadmin/category_banner/view_banner_list'); ?>">Category Banner</a></li>
          ...
          <?php /*?>      <li><a href="<?php echo site_url('torioadmin/product/view_sale_product'); ?>">Sale Product</a></li><?php */?>
             <?php /*?>   <li><a href="<?php echo site_url('torioadmin/product/view_featured_product'); ?>">Featured Product</a></li>
                ...
                <li><a href="<?php echo site_url('torioadmin/product/view_price_product'); ?>">Product Price</a></li>
                  ...
                  <li><a href="<?php echo site_url('torioadmin/shipping_policy/edit'); ?>">Product Shipping And Policy</a></li>
            </ul>
        </li>
        ...
        <li><strong>Content</strong>
        	<ul>
                ...
                <li><a href="<?php echo site_url('torioadmin/secondary_menu'); ?>">Secondary Navigation</a></li>	
                 <li><a href="<?php echo site_url('torioadmin/footer_menu'); ?>">Footer Menu</a></li>	
                 <li><a href="<?php echo site_url('torioadmin/contact_us'); ?>">Contact Us</a></li> 
            </ul>
        </li>
        ...
        <li><strong>E-Channel</strong>
            <ul>
                <li><a href="<?php echo site_url('torioadmin/channel');?>">E-Channel List</a></li>
                <li><a href="<?php echo site_url('torioadmin/channel/banner');?>">E-Channel Banner</a></li>
            </ul>
        </li>
        <li><strong>E-Store</strong>
            <ul>
                <li><a href="<?php echo site_url('torioadmin/store');?>">E-Store List</a></li>
                <li><a href="<?php echo site_url('torioadmin/store_logo');?>">E-Store logo</a></li>
                <li><a href="<?php echo site_url('torioadmin/store/banner');?>">E-Store Banner</a></li>
            </ul>
        </li>
        <li><strong>About Us</strong>
            <ul>
                <li><a href="<?php echo site_url('torioadmin/about_us/banner');?>">About Us Banner</a></li>
                <li><a href="<?php echo site_url('torioadmin/about_us');?>">About Us List</a></li>
                <li><a href="<?php echo site_url('torioadmin/about_us/point');?>">About Us Point</a></li>
            </ul>
        </li>
        <li>Master Setting
        	<ul>
