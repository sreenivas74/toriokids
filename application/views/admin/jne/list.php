...
<div id="content">
    ...
    <div id="submenu">
        <ul>
        	<li><a class="defBtn" href="<?php echo site_url('torioadmin/jne/view_province');?>"><span>Province List</span></a> <a class="defBtn" href="<?php echo site_url('torioadmin/jne/add_city');?>"><span>Add City</span></a> 
