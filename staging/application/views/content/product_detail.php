...
<div class="productDetails">
    <div class="slide">
        ...
        <div class="best2"></div>
        <?php }?>
		<?php if($product['sale_product']==1 && $product['discount']>0 && $schedule_sale){?><div class="discFlag"><?php echo round($product['discount'])?>% OFF</div><?php }?>
        ...
        <form id="buy_form_d" name="buy_form_d" method="post" enctype="multipart/form-data" action="#" onsubmit="return false;">
            ...
            <div class="size">
				...
				<?php $i=1; if($sku) foreach($sku as $sk){
                    ...
                    <li>
                    	<a class="sku_item_d" onclick="changeClass_d(this, <?php echo $sk['id']?>)" href="javascript:void(0);" data-status="<?php echo ($sk['active']==1)?1:0?>"><?php if($sk['active']==1) echo $sk['size'];else echo "<span style='color:red'>Sold Out</span>";?></a>
                    </li>
				<?php }$i++;} ?>
                </ul>
