<div id="content">
	<h2>E-Channel &raquo; Edit Banner</h2>
	<form method="post" id="edit_store_form" enctype="multipart/form-data" action="<?php echo site_url('torioadmin/channel/do_edit_banner');?>" >
    <?php if($detail){ ?>
    <dl>
        <dd>Title</dd>
