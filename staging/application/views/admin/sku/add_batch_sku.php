...
$(document).ready(function(){
	...
	$("#check_all").click(function(){
		...
		if(check) $('.checkBox').attr('checked', true);
...
<div id="content">
    ...
    <div class="add_size" style="display:none;">
    	<input id="check_all" type="checkbox" value="Check All" /> Check All<br /><br />
    	<input id="add_field" type="button" class="defBtn" value="Add New"/></div>
