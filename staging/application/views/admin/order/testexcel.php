...
<table class="noborder">
    <tr>
	    <td><img src="<?php echo base_url()?>templates/images/toriologo.png"></td>
    </tr>
</table><br>
<br>
...
<table width="100%">
    ...
    <tr>
        ...
        <td align="left"><?php if($list['sku_code']!='') echo '('.$list['sku_code'].') ' ?><?php echo find('name',$list['product_id'],'product_tb');?></td>
                ...
                <table width="100%" class="withborder">
                    ...
                    <tr>
                        ...
                        <?php $reg=find('regular_fee',$detail['city'],'jne_city_tb'); 
							...
							$method=0; if($reg==$detail['shipping_method_fee']) $method=0; 
							if($exp==$detail['shipping_method_fee']) $method=1;  ?>
                        <td><?php if($method==0) echo "REGULAR"; if($method==1) echo "EXPRESS"?></td>
                    </tr>
                    <tr>
        ...
        <td width="50%">
        	<div style="float:right;">
                <table width="100%" class="withborder">
                    ...
                    <tr>    
                        <td><b>Email</b></td><td><?php echo $sender_detail['email'];?></td>
                    </tr>
                </table>
            </div>
        </td>
