<div id="content">
    ...
    <label><input type="checkbox" name="active_coupon" id="active_coupon" value=1  <?php if($coupon_active) if($coupon_active['active']==1) echo "checked"; ?> /> Coupon Active</label> 
...
<script>
 $(document).ready(function(){
        $('#active_coupon').click(function(){
			...
			$.ajax({
				type:"POST",
				url:base_url+'torioadmin/coupon/set_active_coupon',
				data:{check:check},
