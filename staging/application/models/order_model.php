...
class Order_model extends CI_Model{
	...
	function check_order_number($order_number,$user_id)
	{
		$q="select * from order_tb where order_number='".esc($order_number)."' and user_id='".esc($user_id)."' and confirm_payment_flag=0 ";	
		$query = $this->db->query($q);
		return $query->row_array();
	}
