...
class Content_page extends CI_Controller {
	...
	function view_faq()
	{
		...
		$this->data['category']=$this->content_page_model->get_active_faq_category_list();
		 ...
		 if(!empty($_FILES['file']['name']))
                {
                        ...
                        $config['upload_path'] = 'userdata/redactor/';
                        ...
                        if($this->upload->do_upload('file'))
                        {
                                ...
                                $json = array(
                                        'filelink' => base_url("userdata/redactor/{$image_data['file_name']}")
                                );
