...
class CI_Email {
	...
	var	$smtp_host		= "smtp.mandrillapp.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "noreply@toriokids.com";		// SMTP Username
	var	$smtp_pass		= "09mqlPnk1MDJQspLhZuEZg";		// SMTP Password
