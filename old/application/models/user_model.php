...
class User_model extends CI_Model{
	...
	{
		$sql="select a.*, b.name, b.alias, b.weight, b.msrp, b.price as sell_price, b.sku_code from order_item_tb a, product_tb b where  a.product_id=b.id and a.order_id='".esc($id)."'";
		$query = $this->db->query($sql);
		return $query->result_array();
	}
