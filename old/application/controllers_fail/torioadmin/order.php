...
class Order extends CI_Controller{
	...
	function get_method(){
		$id = $_POST['id'];
		$this->data['method'] = $this->jne_model->get_city_by_id($id);
	...
	function add_order_manual(){	
		...
		$province_id = find('jne_province_id', $city, 'jne_city_tb');
		$province_name = find('name', $province_id, 'jne_province_tb');
		$city_name = find('name', $city, 'jne_city_tb');
