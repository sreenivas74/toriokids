...
//		if(!$_POST)
	...
	{	
		if($id){
			...
			echo json_encode(array('id'=>$list_address['id'],'recipient_name'=>$list_address['recipient_name'],'shipping_address'=>$list_address['shipping_address'],'phone'=>$list_address['phone'],'province'=>$list_address['province'],'city'=>$list_address['city'],'zipcode'=>$list_address['zipcode'],'jne_kecamatan_name'=>find('name',$list_address['city'],'jne_city_tb')));
		}
	}
