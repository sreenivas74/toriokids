        ...
        <div class="editAccBox">
            ...
            <div class="myOrderDetail">
                <table>
                    ...
                    <tr>
                    	<td colspan="6" class="row1">
                        <div class="grandTotalLeft">Discount <?php $discount=(($shipping['discount_price']/$total_price)*100); 
						printf("%1.2f ", $discount."%"); 
						?>%</div>
                    ...
                    <tr>
                        <td colspan="5">
                            ...
                            <div class="shippingOrderRight">
                                ...
                                <?php echo find('name', $shipping['city'], 'jne_city_tb');?><br />
