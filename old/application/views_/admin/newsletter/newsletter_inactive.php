<div id="content">
<h2>Newsletter Inactive &raquo; List</h2>
<div id="submenu">
    <ul>
        <li><a class="defBtn" href="<?php echo site_url('torioadmin/newsletter/download_csv_form_inactive');?>"><span>Download CSV newsletter</span></a></li>
    </ul>
</div>
<?php if($newsletter!=""){?>
