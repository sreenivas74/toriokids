    	...
    	<dl>
            ...
            <dt>
				...
				if($category) foreach ($category as $list){?>
                	<p><label>
                        <input id="inlineCheckbox<?php echo $list['id'];?>" type="checkbox"  value="<?php echo $list['name'];?>" name="category_name[]" onclick="get_category_downlink(<?php echo $list['id'];?>)"/> <?php echo $list['name'];?>
                	</label></p>
					<?php 
                	...
                	<label class="downlink<?php echo $list['id'];?>" style="display:none;padding-left:15px;">
                        <input type="checkbox" value="<?php echo $slist['name'];?>" name="sub_category_name[]"/> <?php echo $slist['name'];?>
                	</label>
            	<?php 
						}
					}
