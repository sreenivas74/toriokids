...
<div id="content">
    ...
    <dl>
        ...
        <dl>
            <dd>MSRP</dd>
            <dt><input class="txtField validate[required]" type="text" name="msrp" id="msrp"  class="msrp_price" onkeyup="get_discount_selling();" value="<?php echo $detail['msrp']?>"/></dt>
        </dl>
         <dl>
            <dd>Discount</dd>
            <dt><input class="txtField validate[required]" type="text" name="discount" id="discount"  class="discount_price" onkeyup="get_discount_selling();" value="<?php echo $detail['discount']?>"/></dt>
        </dl>
        
        <dl>
            <dd>Selling Price</dd>
            <dt><input class="txtField validate[required]" type="text" name="price" id="price"  class="selling_price" onkeyup="get_total_discount();" value="<?php echo $detail['price']?>"/></dt>
        </dl>
        <dl>
            <dd>Description</dd>
