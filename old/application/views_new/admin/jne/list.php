...
<div id="content">
    ...
    <table class="defAdminTable" width="100%" id="table-1">
        <thead>
        	<tr>
                ...
                <?php /*?><th width="24%">Province</th><?php */?>
                <th width="24%">City</th>
                ...
                <th width="10%" colspan="2">Precedence</th>
            </tr>
        </thead>
        <tbody>
        <?php $no=1; 
    ...
    <tr id="<?php echo $list['id'];?>">
                ...
                <?php /*?><td valign="top"><?php echo find('name', $list['jne_province_id'], 'jne_province_tb');?></td><?php */?>
                ...
                <td valign="top">
    			<?php if ($list['precedence'] != first_precedence('jne_city_tb')){?>
    				<a href="<?php echo site_url('torioadmin/jne/up_precedence_jne_city/'.$list['id']);?>">Up</a> 
				<?php }?>
                </td>
                <td valign="top">
                <?php if ($list['precedence'] != last_precedence('jne_city_tb')){?>
                	<a href="<?php echo site_url('torioadmin/jne/down_precedence_jne_city/'.$list['id']);?>">Down</a>
                <?php }?>
                </td>
    		</tr>
    		<?php $no++; } else if(!$jne){ ?> 
