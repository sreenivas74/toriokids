    ...
    <div class="headerBox">
        ...
        <a href="#" class="menuMobile"></a>
            <div class="qtyCartMobileBox">
                <a href="<?php echo site_url('shopping_cart');?>" class="qtyCartMobile"></a>
                <div class="notif"><a href="<?php echo site_url('shopping_cart');?>" class="notifNumber"><?php echo $total_item?></a></div>
            </div>
