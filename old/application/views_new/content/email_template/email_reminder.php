        ...
        <table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" width="800" align="center" style="line-height:18px; padding:10px; border:5px solid #DBF291; background:#fff;">
            ...
            <tr>
                <td><br>
                    ...
                    We haven't received any payment for your order. Please be notified that if you do not make any payments in 48 hours, your order will be automatically cancelled.
                    <br /><br />
                    ...
                    <table width="100%" style="font-size:11px; border:1px solid #4D4D4D;" cellpadding="10">
                        ...
                        <?php $total_price=0; $no=1; 
                            ...
                            <tr align="center">
                                ...
                                <td style="border-bottom:1px solid #3e065a; text-align:right;"><?php if(($list['total']-($list['quantity']*$list['sell_price']))==0)echo "-";else echo "(".money($list['total']-($list['quantity']*$list['sell_price'])).")";?></td>
                                <td style="border-bottom:1px solid #3e065a; text-align:right;"><?php echo money($list['quantity']*$list['sell_price']);?></td>
                            ...
                            <tr style="font-size:13px; background:#4D4D4D; color:#fff;">
                                <td colspan="6" align="right"><b>Discount <?php ?></b></td>
            ...
            <tr>
                <td style="padding-top:20px;">
                    ...
                    <table width="100%" style="margin:0px 0; font-size:12px; border:none;" cellpadding="5">
                        ...
                        <tr>
                            <td style="font-weight:bold; vertical-align:top; background:#ddd">Phone:</td>
                            <td style="background:#ddd;"><strong><?php echo $order['phone'];?></strong></td>
                        </tr>
                        <tr>
                            <td style="font-weight:bold; vertical-align:top; background:#ddd">Mobile:</td>
                            <td style="background:#ddd;"><strong><?php echo $order['mobile'];?></strong></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td style="padding-top:20px;">
                    ...
                    <table width="100%" style="margin:0px 0; font-size:12px; border:none;" cellpadding="5">
                        ...
                        <tr>
                            <td style="font-weight:bold; vertical-align:top; background:#ddd">Mobile:</td>
                            <td style="background:#ddd;"><strong><?php echo $user['mobile'];?></strong></td>
                        </tr>
                    </table>
                </td>
            </tr>
           ...
           <tr>
                <td style="font-size:10px; padding:20px 20px; width:800px; height:100 px; vertical-align:top; display:table-cell; background:#DBF291; color:#A67C52;">
                    <a target ="_blank" style="float:left; margin:0 20px 0 0;" href="#"><img src="<?php echo base_url()?>templates/images/smallLogo.png" /></a><p align="right" style="line-height:28px;">&copy; <?php echo date("Y") ?> Torio Kids. All Rights Reserved.</p>
                </td>
            </tr>
        </table>
    </div> <!--end wrapper-->
