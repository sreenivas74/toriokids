<?php $this->load->view('content/mobile_menu')?><div class="categoriesWrap"><div class="categories">
    <div class="category"><h2>Search</h2></div>
...
<div class="products">
    <div class="productList">
        ...
        <div style="text-align:center; margin:50px auto">
            <?php if($alert) echo $alert; else {?>Sorry, we can't find any products with the keyword "<?php echo $keyword;?>"<?php }?>
        </div>
        <?php }?>
    </div>
</div>
