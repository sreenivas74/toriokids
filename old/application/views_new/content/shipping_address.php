            ...
            <div class="shipping">
                ...
                <dt id="ship_met">
					...
					<?php if( $total_price <= $sm['min_purchase'] && $sm['min_purchase']>0 ){?>
								...
								<?php if($sm['regular_fee']!=""){?><option value="<?php echo $sm['regular_fee'];?>">Regular (<?php if($sm['regular_fee']==0)echo "Free"." ".$sm['regular_etd']; else echo money($sm['regular_fee'])." ".$sm['regular_etd'];?>)</option>
								<?php } ?>   
