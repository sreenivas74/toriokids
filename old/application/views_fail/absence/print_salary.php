...
if($salary_list)foreach($salary_list as $list){
    ...
    <?php if(find_2('department_id','userid',$list['user_id'],'employee_tb')>2){?>
        ...
        <div id="header" style="overflow:visible;">
            ...
            <div id="header_left" style="height:125px !important;">
        ...
        <br /><br />
            <table border="0" width="100%">
                <tr>
                    ...
                    <td width="20%" valign="top"><b><?php echo $list['nik']?></b></td>
                    <td width="2%"></td>
                    <td width="25%"></td>
                    <td width="20%"></td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><?php echo $list['firstname'].' '.$list['lastname']?></td>
                    <td></td>
                    <td valign="top">Grade</td>
                    <td valign="top"><?php echo $list['grade']?></td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><?php echo $list['job_title']?></td>
                </tr>
                <tr>
                ...
                <?php if($list['tunjangan_jabatan']>0){
					$total_get+=$list['tunjangan_jabatan'];
					?>
                <tr>
                  <td valign="top">Tunjangan Jabatan</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_jabatan'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                <?php }?>
                <?php if($list['tunjangan_bahasa_inggris']>0){
					$total_get+=$list['tunjangan_bahasa_inggris'];?>
                <tr>
                  <td valign="top">Tunjangan Bahasa Inggris</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_bahasa_inggris'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                <?php }?>
                <?php if($list['tunjangan_access_control']>0){
					$total_get+=$list['tunjangan_access_control'];?>
                
                <tr>
                  <td valign="top">Tunjangan Access control</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_access_control'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                ...
                <?php }?>
                <?php if($list['tunjangan_fire_alarm_system']>0){
					$total_get+=$list['tunjangan_fire_alarm_system'];?>
                <tr>
                  <td valign="top">Tunjangan Fire Alarm system</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_fire_alarm_system'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                ...
                <?php }?>
                <?php if($list['tunjangan_fire_suppression']>0){
					$total_get+=$list['tunjangan_fire_suppression'];?>
                <tr>
                  <td valign="top">Tunjangan Fire Suppression</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_fire_suppression'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                <?php }?>
                <?php if($list['tunjangan_bas']>0){
					$total_get+=$list['tunjangan_bas'];?>
                <tr>
                  <td valign="top">Tunjangan BAS</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_bas'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                ...
                <?php }?>
                <?php if($list['tunjangan_gpon']>0){
					$total_get+=$list['tunjangan_gpon'];?>
                <tr>
                  <td valign="top">Tunjangan GPON</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_gpon'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                <?php }?>
                <?php if($list['tunjangan_perimeter_intrusion']>0){
					$total_get+=$list['tunjangan_perimeter_intrusion'];?>
                <tr>
                  <td valign="top">Tunjangan Perimeter intrusion</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_perimeter_intrusion'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                ...
                <?php }?>
                <?php if($list['tunjangan_public_address']>0){
					$total_get+=$list['tunjangan_public_address'];?>
                <tr>
                  <td valign="top">Tunjangan Public Address</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_public_address'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
                ...
                <?php }?>
                <?php if($list['tunjangan_fiber_optic']>0){
					$total_get+=$list['tunjangan_fiber_optic'];?>
                <tr>
                  <td valign="top">Tunjangan Fiber Optic</td>
                  <td valign="top" align="right"><?php echo currency($list['tunjangan_fiber_optic'])?></td>
                  <td></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top" align="right">&nbsp;</td>
                </tr>
        ...
        s<br />
        <?php //pre($list)?>
        <br /><?php //if(find_2('nik','userid',$list['user_id'],'employee_tb')=='08820004')pre($list);?>
            <table border="0" width="100%">
                <tr>
                    <td width="25%" valign="top">Code</td>
                    <td width="20%" valign="top"><b><?php echo $list['nik']?></b></td>
