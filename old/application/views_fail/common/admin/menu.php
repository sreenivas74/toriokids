...
<div id="nav">
    ...
    <ul>
		...
		<li><strong>Torio Flash Sale</strong>
        	<ul>
            	<li><a href="<?php echo site_url('torioadmin/sale/flash_sale') ?>">List Flash Sale</a></li>
            	
            </ul>
        </li>
        <li><strong>Torio Coupon</strong>
        	<ul>
            	<li><a href="<?php echo site_url('torioadmin/coupon/'); ?>">List Coupons</a></li>
            	
            </ul>
        </li>
        <li><strong>Torio Discount Cart</strong>
        	<ul>
            	<li><a href="<?php echo site_url('torioadmin/discount_cart/'); ?>">List Discount Cart</a></li>
