  <script>
    ...
    </script><?php //pre($po_client_item);?>	<table width="1218px" border="1" id="item_product"  class="myform">
    ...
    <tr>
        ...
        <td><input type="text" name="qty1_<?php echo $i?>" id="qty1_<?php echo $i?>" onkeyup="formatAmount(this.value,<?php echo $i?>,'qty1','total1_','qty1_','price1_','disc1_','subtotal1','item_product_total','subtotal3','subtotal','disc3','discount','ppn3','is_ppn','total3')" style="width:50px; text-align:center;" />
        </td>
            
        <td><input type="text" name="price1_<?php echo $i?>" id="price1_<?php echo $i?>" onkeyup="formatAmount(this.value,<?php echo $i?>,'price1','total1_','qty1_','price1_','disc1_','subtotal1','item_product_total','subtotal3','subtotal','disc3','discount','ppn3','is_ppn','total3')" style="width:100px; text-align:right"/>
        </td>  
        ...
        <?php /*?><td><input type="text" name="total1_<?php echo $i?>" id="total1_<?php echo $i?>" readonly="readonly" style="width:100px; text-align:right"/></td><?php */?>
        ...
        <td><input type="text" name="acc_number1_<?php echo $i?>" id="acc_number1_<?php echo $i?>" style="width:100px"></td>
    </tr>
    <?php }?>
   
    
</table> <input type="hidden" name="item_product_total" id="item_product_total" value="5" />
