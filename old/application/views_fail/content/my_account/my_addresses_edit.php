        ...
        <table>
            ...
            <tr>
                ...
                <td id="show_city">
                    ...
                    <input type="text" class="inputTxt" id="autokecamatan" value="<?php echo find('name',$address['city'],'jne_city_tb');?>"></input>
                    <input type="hidden" name="select_city" id="city" value="<?php echo $address['city']?>" /> 
