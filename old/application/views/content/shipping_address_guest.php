...
function submit_form()
{
	...
	else if($("#autokecamatan2").val()=='' && ($("#city_billing").val()==0 || $("#city_billing").val()=='')){
        ...
        <div class="shippingCon">
        	<div class="shippingBox">
            	<div class="shippingCol">
                    ...
                    <div class="shipping">
                        <dd>City</dd>
                        <dt id="show_kecamtan2">
                            <span class="shippingInfoCon">
                            <input type="text" class="textTxt validate[required]" id="autokecamatan2" onchange="fill_value_billing(this.value);" /> 
                            <input type="hidden" name="personal_city" id="city_billing" />  
                            <script>
