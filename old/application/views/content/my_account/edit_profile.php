...
<div class="editContainer">
    ...
    <form id="account_form" name="account_form" method="post" action="<?php echo site_url('my_account/do_edit');?>" onsubmit="return validation()">
        ...
        <table>
            ...
            <tr>
                ...
                <td id="show_city">
                    ...
                    <input type="text" class="inputTxt" id="autokecamatan" value="<?php if($account['city']) echo api_city_name($account['city']);?>"></input>
