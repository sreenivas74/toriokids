...
<div class="editContainer">
    ...
    <div class="editAccCon">
        ...
        <table>
            ...
            <tr>
                <td>City</td>
                <td><input class="inputTxt" type="text" disabled="disabled" name="city" id="city" value="<?php if($account['province'] && $account['city']) echo api_province_name($account['province'])." | ".api_city_name($account['city']);?>" /></td>
            </tr>
            <tr>
                <td>Zipcode</td>
