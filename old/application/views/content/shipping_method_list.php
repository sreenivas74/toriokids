...
<select class="recipient" name="shipping_method" id="ship_method">
   ...
   <?php if($sm['regular_fee']!=""){?><option value="<?php echo $sm['regular_fee'];?>">Regular (<?php if($sm['regular_fee']==0)echo "Free"." ".$sm['regular_etd'] . ' days'; else echo money($sm['regular_fee'])." ".$sm['regular_etd'] . ' days';?>)</option><?php } ?>
