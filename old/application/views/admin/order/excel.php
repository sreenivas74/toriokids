    ...
    <table border="1" class="tableContent" width="50%">
        ...
        <tbody>
			<tr class="form_data">	
                ...
                <td valign="top" align="right"><?php if($method==0) echo "REGULAR"; if($method==1) echo "EXPRESS";?></td>
			</tr>
			<tr class="form_data">	
                <td valign="top" align="right" colspan="4" bgcolor="#CCCCCC">Kirim Atas Nama:</td>  
