...
<link href="<?php echo base_url();?>templates/css/flipclock.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="<?php echo base_url();?>templates/js/countdown.js"></script>

<script type="text/javascript" src="<?php echo base_url();?>templates/js/overthrow.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>templates/js/flipclock.min.js"></script>
...
<div id="errorMyAccount" class="popup" style="display:none;">
    <div class="popupContent">
        <p>Please complete your profile (city)<br />
		<a href="<?php echo site_url('my_account/edit_profile') ?>">Click here to edit your profile</a></p>
        <input id="closeNotif" class="addToCart" type="submit" value="OK" onclick="window.location='<?php echo site_url('my_account/edit_profile') ?>'"/>
    </div>
    <div class="close"></div>
</div>
</body>
...
FB.api('/me/feed', 'post', { message: 'Saya baru saja mendapatkan special discount 20% dari Toriokids.- Ayo dapatkan diskon 20% dari Torio Kids, Like Facebook Torio Kids & kunjungi website kita di toriokids.com !',link:'www.toriokids.com',picture:'http://www.toriokids.com/torio2/userdata/toriokids_fb_post.jpg' }, function(response) {
 ...
 <script type="text/javascript">
	...
	$(document).ready(function() {
		...
		clock3Hours = $('.desktopFlashSale .fsCd').FlipClock(<?php echo $clock_end ?>,{
			clockFace: 'HourlyCounter',
			countdown:true
		});
		mobileClock3Hours = $('.mobileFlashSale .fsCd').FlipClock(<?php echo $clock_end ?>,{
			clockFace: 'HourlyCounter',
			countdown:true
		});
		clock = $('.desktopFlashSale .beforeFsCd').FlipClock(<?php echo $upcoming_time ?>,{
			clockFace: 'DailyCounter',
			countdown:true,
			showSeconds: false
		});
		mobileClock = $('.mobileFlashSale .beforeFsCd').FlipClock(<?php echo $upcoming_time ?>,{
			clockFace: 'DailyCounter',
			countdown:true,
			showSeconds: false
		});
		...
		//countdown module
		clockCd = $('.desktopCountdown .beforeCd').FlipClock(<?php echo $upcoming_cd_time ?>,{
			clockFace: 'DailyCounter',
			countdown:true,
			showSeconds: false
		});
		mobileClockCd = $('.mobileCountdown .beforeCd').FlipClock(<?php echo $upcoming_cd_time ?>,{
			clockFace: 'DailyCounter',
			countdown:true,
			showSeconds: false
		});
